...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Island+Moments&display=swap"
        rel="stylesheet">
...
<body class="d-flex flex-column h-100 libro">
        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <a href="http://breezeapp/dashboard">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <a class="inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out"
                                href="http://breezeapp/libro">
                                Libro
                            </a>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <a class="inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out"
                                href="http://breezeapp/genero">
                                Genero
                            </a>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                          <a class="inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out"
                              href="http://breezeapp/autor">
                              Autor
                          </a>
                      </div>
                    </div>
                        ...
                        <div class="relative" x-data="{ open: false }" @click.outside="open = false"
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div class="rounded-md ring-1 ring-black ring-opacity-5 py-1 bg-white">
                                    <!-- Authentication -->
                                    <form method="POST" action="http://breezeapp/logout">
                                        <input type="hidden" name="_token"
                                            value="zB8fZfMJnUKUxZCjjQkud5gtb0doLz59KPfNga3b">
                                        <a class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out"
                                            href="http://breezeapp/logout" onclick="event.preventDefault();
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="px-4">
                        <div class="font-medium text-base text-gray-800">user1</div>
                        <div class="font-medium text-sm text-gray-500">user@gmail.com</div>
                    </div>

                    <div class="mt-3 space-y-1">
                        <!-- Authentication -->
                        <form method="POST" action="http://breezeapp/logout">
                            <input type="hidden" name="_token" value="zB8fZfMJnUKUxZCjjQkud5gtb0doLz59KPfNga3b">
